...
const SeniorYear = () => {
  ...
  const blueprintHeadingStyle = { color: '#1a1a2e', marginBottom: '12px' };
  const blueprintListStyle = { color: '#1a1a2e', listStyle: 'none', padding: 0, margin: 0 };
  const blueprintItemStyle = { color: '#1a1a2e', marginBottom: '8px' };
  ...
  <nav className={`sidebar-links ${sidebarOpen ? 'sidebar-links--open' : ''}`}>
    ...
    <button onClick={() => scrollToSection('looking-back')} className="sidebar-link">Looking Back</button>
        ...
        <main className="main-content">
          ...
          <section id="reality-check" className="content-section bg-white">
            ...
            <div className="signature-pull-quote">
              ...
              <span className="spq-source">Senior Year</span>
            </div>
          </section>
      ...
      <div className="page-navigation">
        <Link to="/junior" className="nav-button prev-button"><ArrowLeft size={20} /><span>Previous: Junior Year</span></Link>
        <Link to="/outta-here" className="nav-button next-button"><span>Next: Outta Here Year</span><ArrowRight size={20} /></Link>
      </div>
